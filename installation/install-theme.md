...
After you download the package from ThemeForest, please unzip it. You'll see a file called `motta.zip`, which is the main file needed to upload and install.
...
**Step 1** - If you have downloaded the Full Theme Package from ThemeForest, please unzip the package file to get the theme file `motta.zip`. Unzip the `motta.zip` file, you'll get a folder `Motta`.
...
**Step 3** - Log in to your WordPress Dashboard and navigate to **Appearance > Themes** and clicking the **Activate** button of the Motta theme.
...
1. **"Are you sure you want to do this?"** error
	...
	If you get the “Are You Sure You Want To Do This” message when installing Motta.zip file via WordPress, it means you have an upload file size limit that is set by your host. If this happens, please install the theme via FTP or contact your hosting company and ask them to increase the limit.
