...
The easiest way to import our demo content is to use our [Soo Demo Importer plugin](https://github.com/uixthemeswp/motta/raw/main/plugins/soo-demo-importer.zip). Our importer will give you all pages and posts, several sample sliders, widgets, menus, theme options, assigned pages, and more. This is recommended to do on fresh installs. It will not replace content like posts, pages, portfolio, etc. And it will not delete current menus or sliders. It will, however, configure and use our demo menus, add sliders and replace theme options, reading settings and widgets.
...
- **Required Plugins**: Installed Motta's required plugins. Also make sure you’ve installed the recommended plugins.
- **Motta Addons**: Make sure you're using the latest version of this plugin.
...
**Step 1** - Downnload and install the plugin [Soo Demo Importer](https://github.com/uixthemeswp/motta/raw/main/plugins/soo-demo-importer.zip). It is a required plugin if you want to enable the "One Click Import Demo" feature.
...
1. **I don't see Import Demo Data menu**
	...
	This feature requires you to install an additional plugin [Soo Demo Importer](https://github.com/uixthemeswp/motta/raw/main/plugins/soo-demo-importer.zip). Please make sure you finised the **Step 1** above.
