...
**Step 2** – Locate your Motta purchase. On there, you’ll see how many months of support you have remaining, and beside it there’s an **Extend Now** link.

**Step 3** – Click the **Extend Now** link, and it will redirect you to the Motta Theme's item page.
...
1. Make sure you are running the [latest version of Motta](installation/update-theme.md) and the latest version of [WordPress](https://wordpress.org/).
...
1. Switch back to the default theme (Tweentyseventeen) to see if it fixes the issue. If it does, you can ensure this is a bug of Motta.
...
1. **Where can I place my support ticket?**
	...
	You can visit our [Support System](http://uix.ticksy.com/) to place your tickets. It requires you to login with Envato account which is the account you used to purchased Motta on ThemeForest.